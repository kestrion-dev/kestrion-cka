# M12 - NetworkPolicy y Segmentación
...
De M02 (Arquitectura) usarás el concepto de CNI, Container Network Interface: NetworkPolicy es precisamente una de las responsabilidades que un CNI puede implementar o no.

De M06 (Extension Interfaces) usarás la comprensión de que Kubernetes define el contrato de NetworkPolicy en su API, pero es Calico, tu CNI, quien realmente traduce esas reglas en filtrado de paquetes real.
