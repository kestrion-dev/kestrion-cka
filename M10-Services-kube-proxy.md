...
De M02 (Arquitectura) usarás el rol de kube-proxy como componente de cada nodo, y el hecho de que corre como DaemonSet, ya visto en M07.

De M07 (Workloads) usarás el Headless Service que ya creaste para el StatefulSet, un tipo especial de Service que se retoma aquí con más profundidad.
