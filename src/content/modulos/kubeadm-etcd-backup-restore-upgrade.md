...
De [M02 (Arquitectura)](/modulos/arquitectura-kubernetes/) usarás el concepto de static pods, el rol de cada componente del control plane, y la regla de que solo kube-apiserver habla directamente con etcd. Este módulo pone en práctica esa teoría con manifiestos y comandos reales.
