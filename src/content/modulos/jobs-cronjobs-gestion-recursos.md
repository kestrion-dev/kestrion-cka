...
De [M02 (Arquitectura)](/modulos/arquitectura-kubernetes/) usarás el reconciliation loop, aplicado ahora a un controller cuyo estado deseado es "N ejecuciones completadas con éxito", no "N réplicas corriendo indefinidamente".

De [M07 (Workloads)](/modulos/workloads-deployments-daemonsets-statefulsets/) usarás la diferencia entre gestionar pods de larga duración, Deployment, y la lógica de template más selector que también usa Job.
