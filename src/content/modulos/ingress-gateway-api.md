...
access: free
updated: "2026-09-08"
prerequisites: [helm-kustomize-crds-operators, services-kube-proxy]
---
...
De [M06 (Helm)](/modulos/helm-kustomize-crds-operators/) usarás la instalación de controllers de terceros vía Helm, exactamente el mismo patrón para instalar tanto el Ingress Controller como el Gateway Controller de este módulo.

De [M10 (Services)](/modulos/services-kube-proxy/) usarás el hecho de que tanto un Ingress como una HTTPRoute enrutan tráfico hacia un Service existente, nunca directamente hacia pods.
