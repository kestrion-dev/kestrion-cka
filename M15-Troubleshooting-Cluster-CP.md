# M15 - Troubleshooting: Cluster y Control Plane
...
Este módulo depende de prácticamente todo el curso hasta ahora: M02 para los componentes y el flujo del control plane, M03 para static pods, certificados y etcd, M04 para el concepto de quorum si el cluster fuera HA, y M05 para distinguir un fallo de autenticación de uno de autorización.
